...
class ForemanInventory(object):
    config_paths = [
        "/Users/zhoukanggen/Desktop/python/foreman_dev.ini",
        os.path.dirname(os.path.realpath(__file__)) + '/foreman_dev.ini',
    ]
    ...
    def parse_cli_args(self):
        ...
        parser.add_argument('--list', action='store_true',
                            default=True, help='List instances (default: True)')
        ...
        for host in self._get_hosts():
            ...
            if val:
                safe_key = self.to_safe('%s%s_%s' % (
                    self.group_prefix, group, val.lower()))
